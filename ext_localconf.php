...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['cms/layout/class.tx_cms_layout.php']['list_type_Info']['tx_syntaxhighlight_controller'][] = 'EXT:syntaxhighlight/api/class.syntaxhighlightAPI.php:tx_syntaxhighlightAPI->getExtensionSummary';
